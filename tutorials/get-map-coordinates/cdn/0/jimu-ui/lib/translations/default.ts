export default {
  ...
  rename: 'Rename',
  affectedWidgets: 'This data is used in the following widgets and removing it may break them.',
  removeDataSource: 'Remove data',
  youAreRemovingData: 'You are removing data:',
  howToRemoveWidgetsTip: 'Select the widgets you want to delete alongside the data. The unselected widgets will be kept and you can reconfigure them later.',
  ...
  // guide what's new
  whatsNewStep1Title: "What's new",
  whatsNewStep1Content: 'Here are some of the latest features in Experience Builder.',
  whatsNewStep2Title: 'New: Query widget',
  whatsNewStep2Content: 'Allows you to retrieve information from a data source by executing an attribute or spatial filter query.',
  whatsNewStep3Title: 'New: Chart widget',
  whatsNewStep3Content: 'Visualizes quantitative attributes from an operational layer to reveal potential patterns or trends.',
  whatsNewStep4Title: 'New: Coordinate Conversion widget',
  whatsNewStep4Content: 'Allows you to convert coordinates between coordinate systems using multiple notation formats.',
  whatsNewStep5Title: 'New: Branch Version Management widget',
  whatsNewStep5Content: 'Allows you to manage versions in web feature layers feature services that work with branch versioned datasets.',
  whatsNewStep6Title: 'New: URL component',
  whatsNewStep6Content: 'Allows you to configure dynamic URL and obtain app or external URL parameters from content embedded inside Embed widget.',
  whatsNewStep7Title: 'New: Data action',
  whatsNewStep7Content: 'Provides out-of-the-box actions (such as zoom to, export to CSV file, and view in table) based on a subset of the data.',
  whatsNewStep8Title: 'Window',
  whatsNewStep8Content: 'Supports cutomizing position, size and layout for different screen sizes.',
  whatsNewStep9Title: 'Map',
  whatsNewStep9Content: 'Provides quality options for web scenes to balance the visual effect and loading efficiency.',
  whatsNewStep10Title: 'Table',
  whatsNewStep10Content: 'Supports attribute editing by checking data capabilities, user accounts credentials, and privileges.<br/>Provides two record-selection modes: single & multiple.',
  whatsNewStep11Title: 'Data source',
  whatsNewStep11Content: 'Supports configuring widgets with output data generated from Query or Chart widget.<br/>Supports configuring widgets with selected features as data sources.',
  whatsNewStep12Title: 'Layout',
  whatsNewStep12Content: 'Provides advanced snap lines to assist in aligning or accurately positioning widgets in full screen app page, window, or fixed panel/sidebar layout.',
  whatsNewStep13Title: 'Template',
  whatsNewStep13Content: 'Provides four new app default templates and three new page templates to visualize data via a narrative tour or single/multi-page data monitor layouts.',
  whatsNewStep14Title: 'See all the new features',
  whatsNewStep14Content: 'Learn more',
