/** @jsx jsx */
import { React, jsx, css, classNames, lodash, BoundingBox, SerializedStyles } from 'jimu-core'
import {
  LayoutItemProps,
...
StateToLayoutItemProps & OwnProps> {
  ...
  getStyle (itemSetting: RowLayoutItemSetting): SerializedStyles {
    ...
    if (itemSetting.offsetX != null || itemSetting.offsetY != null) {
    ...
    if (isMultiRow) {
      return css`
        ...
        transform: ${itemSetting.offsetX != null || itemSetting.offsetY != null ? `translate(${itemSetting.offsetX ?? 0}px, ${itemSetting.offsetY ?? 0}px)` : null};
