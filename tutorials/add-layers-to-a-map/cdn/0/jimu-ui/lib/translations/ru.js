define({
  ...
  serie: 'Серия',
  axes: 'Оси',
  stacking: 'В несколько строк',
  sideBySide: 'Рядом',
  stacked: 'Составная',
  stacked100: '100% Составная',
  decimal: 'Десятичные числа',
  show1000Seperator: 'Показывать разделители тысяч',
  to: 'до',
  lineStyle: 'Стиль линии',
  columnOutline: 'Контур',
  sumOfValue: 'Суммарное значение',
  selection: 'Выборка',
  ...
  showSelection: 'Показать выборку',
  clearSelection: 'Очистить выборку',
  searchMore: 'Искать больше',
  noData: 'Нет данных',
  allTag: '- Все -',
  allDynamicTag: '- Все (динамические)',
  outputNoValueWarning: 'Этот фильтр использует источник выходных данных из другого виджета. В запущенном приложении уникальные значения будут динамически генерироваться после выполнения соответствующих действий.',
  ...
  dashDoubleDot: 'Двойная точка тире',
  double: 'Двойная',
  solid: 'Сплошной',
  offsetX: 'Сдвиг по X',
  offsetY: 'Сдвиг по Y',
  ...
  all: 'Все',
  selectDataPlaceholder: 'Щелкните Выбрать данные, чтобы добавить новый источник данных к виджету.',
  outputDataIsNotGenerated: '{outputDsLabel} еще не создан. Сначала запустите {sourceWidgetName}.',
  ...
  imageTypeError: 'Вы указали тип изображения, который не поддерживается. Используйте один из следующих типов: PNG, GIF, JPG, JPEG or BMP.',
  // theme-components
  ...
  themeSettingAppElementsDescription2: "Эти цвета могут быть перезаписаны в панели Настройки страницы.",
  ...
  ground: 'Земля',
  outerSpace: 'Пробел',
  clamped2Ground: 'Зафиксировать на земной поверхности',
  relative2Ground: 'Относительно земной поверхности',
  absolute: 'Абсолютный',
  extendPath2Gground: 'Растянуть путь до земной поверхности',
  //jimu-map
  ...
  whatsNewStep2Title: 'Новый: Виджет Запрос',
  whatsNewStep2Content: 'Позволяет получать информацию из исходных данных, выполнив атрибутивный или пространственный запрос.',
  whatsNewStep3Title: 'Новый: Виджет Диаграмма',
  whatsNewStep3Content: 'Отображает количественные атрибуты рабочего слоя для выявления возможных трендов или закономерностей.',
  whatsNewStep4Title: 'Новое: виджет преобразования координат',
  whatsNewStep4Content: 'Позволяет конвертировать координаты между системами координат, используя несколько форматов записи.',
  whatsNewStep5Title: 'Новое: виджет управления сервис-ориентированными версиями',
  whatsNewStep5Content: 'Позволяет управлять сервис-ориентированными версиями в векторных веб-слоях, которые работают с наборами данных сервис-ориентированных версий.',
  whatsNewStep6Title: 'Новый: Компонент URL',
  whatsNewStep6Content: 'Позволяет настраивать динамический URL и получать параметры приложения или внешние URL из ресурсов внутри виджета Встроенный.',
  whatsNewStep7Title: 'Новый: Действия с данными',
  whatsNewStep7Content: 'Обеспечивает внешние действия (такие, как масштабирование, экспорт в файл CSV и просмотр в таблице) для поднабора данных.',
  whatsNewStep8Title: 'Окно',
  whatsNewStep8Content: 'Поддерживает положение, размер и компоновку для разных размеров экрана.',
  whatsNewStep9Title: 'Карта',
  whatsNewStep9Content: 'Предоставляет опции управления качеством для веб-сцен, чтобы сбалансировать визуальный эффект и производительность загрузки.',
  whatsNewStep10Title: 'Таблица',
  whatsNewStep10Content: 'Поддерживает редактирование атрибутов с помощью проверки возможностей данных, учетных записей пользователей и прав доступа.<br/>Поддерживаются два типа выборок: единичные и множественные.',
  whatsNewStep11Title: 'Источник данных',
  whatsNewStep11Content: 'Поддерживает настройку виджетов с выходными данными, создаваемыми виджетами Запрос и Диаграмма.<br/>Поддерживает настройку виджетов через выбор объектов как источников данных.',
  whatsNewStep12Title: 'Компоновка',
  whatsNewStep12Content: 'Предлагает дополнительные линии замыкания для выравнивания или точного размещения виджетов по всей странице экрана приложения, в пределах окна или фиксированной панели/боковой панели.',
  whatsNewStep13Title: 'Шаблон',
  whatsNewStep13Content: 'Предоставляет четыре новых шаблона приложений по умолчанию и три новых шаблона страниц для визуализации данных через тур с описаниями или одно/много - страничные компоновки мониторинга данных.',
  whatsNewStep14Title: 'Посмотреть все новые функции',
  whatsNewStep14Content: 'Подробнее',
  ...
  // dynamic-url-editor
  urlInfo: 'URL-адрес информации',
  urlInfoPanelHint: 'Добавить URL-адрес информации из',
  appUrl: 'URL-адрес приложения',
  emptyHint: 'Допустимые URL-адреса информации для использования отсутствуют.',
  dataPanelTitle: 'Атрибут данных',
  dataPanelHint: 'Добавить атрибуты данных по динамическому URL-адресу',
  dataUnavailableTips: 'Данные недоступны. Сначала подключитесь к действительным источникам данных.',
});